...
<html>
	...
	<body>
		<a href="#edit-technique" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-technique" class="content scaffold-edit" role="main">
			...
			<g:form url="[resource:techniqueInstance, action:'update']" method="PUT" >
