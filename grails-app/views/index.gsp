...
<div role="main" class="main" id="home">
	...
	<div class="container">
		<div class="row" id="features">
			<div class="col-md-8">
				<h2 data-appear-animation="fadeInLeft">
					...
					<div class="col-sm-6">
						<div class="feature-box">
							...
							<div class="feature-box-info">
								...
								<p class="tall">Lorem ipsum dolor sit amet, consectetur
									adip.</p>
							</div>
						</div>
						<div class="feature-box">
						...
						<div class="panel-heading">
							<h4 class="panel-title">
								<a class="accordion-toggle" data-toggle="collapse"
									...
									class="fa fa-usd"></i> Pricing Tables
								</a>
							</h4>
						</div>
						<div id="collapseOne" class="accordion-body collapse in">
							<div class="panel-body">Donec tellus massa, tristique sit
								amet condim vel, facilisis quis sapien. Praesent id enim sit
								amet odio vulputate eleifend in in tortor.</div>
						</div>
					</div>
					<div class="panel panel-default">
						<div class="panel-heading">
							<h4 class="panel-title">
								<a class="accordion-toggle" data-toggle="collapse"
									...
									class="fa fa-comment"></i> Contact Forms
								</a>
							</h4>
						</div>
						<div id="collapseTwo" class="accordion-body collapse">
							<div class="panel-body">Donec tellus massa, tristique sit
								amet condimentum vel, facilisis quis sapien.</div>
						</div>
					</div>
					<div class="panel panel-default">
						<div class="panel-heading">
							<h4 class="panel-title">
								<a class="accordion-toggle" data-toggle="collapse"
									...
									class="fa fa-laptop"></i> Portfolio Pages
								</a>
							</h4>
						</div>
	...
	<section class="parallax parallax_message" data-stellar-background-ratio="0.5">
		<div class="container">
			<div class="row center">
				<div class="col-md-12">
					<i class="fa fa-comments icon-featured"
						data-appear-animation="bounceIn"></i>
					<h2 class="short text-shadow big white bold">
						<strong>We're excited about Porto Template</strong>
					</h2>
					<h3 class="lead white">5,500 customers in 100 countries use
						Porto Template. Meet our customers.</h3>
				</div>
			</div>
		</div>
	</section>
					...
					<ul class="team-list">
						<li class="col-md-3 col-sm-6 col-xs-12">
							<div class="team-item thumbnail">
								<a href="#" class="thumb-info team"> <asset:image alt=""
									height="270" src="img/team/team-1.jpg" /> <span
									class="thumb-info-title"> <span class="thumb-info-inner">John
											Doe</span> <span class="thumb-info-type">CEO</span>
								</span>
								</a> <span class="thumb-info-caption">
									<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.
										Cras ac ligula mi, non suscipitaccumsan.</p> <span
									class="thumb-info-social-icons"> <a data-tooltip
										...
										href="http://www.twitter.com" data-original-title="Twitter"><i
						...
						<li class="col-md-3 col-sm-6 col-xs-12">
							<div class="team-item thumbnail">
								<a href="#" class="thumb-info team"> <asset:image alt=""
									height="270" src="img/team/team-2.jpg" /> <span
									class="thumb-info-title"> <span class="thumb-info-inner">Jessica
											Doe</span> <span class="thumb-info-type">Marketing</span>
								</span>
								</a> <span class="thumb-info-caption">
									<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.
										Cras ac ligula mi, non suscipitaccumsan.</p> <span
						...
						<li class="col-md-3 col-sm-6 col-xs-12">
							<div class="team-item thumbnail">
								<a href="#" class="thumb-info team"> <asset:image alt=""
									height="270" src="img/team/team-3.jpg" /> <span
									class="thumb-info-title"> <span class="thumb-info-inner">Rick
											Edward Doe</span> <span class="thumb-info-type">Developer</span>
								</span>
								</a> <span class="thumb-info-caption">
									<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.
										Cras ac ligula mi, non suscipitaccumsan.</p> <span
						...
						<li class="col-md-3 col-sm-6 col-xs-12">
							<div class="team-item thumbnail">
								<a href="#" class="thumb-info team"> <asset:image alt=""
									height="270" src="img/team/team-4.jpg" /> <span
									class="thumb-info-title"> <span class="thumb-info-inner">Melinda
											Wolosky</span> <span class="thumb-info-type">Design</span>
								</span>
								</a> <span class="thumb-info-caption">
									<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.
										Cras ac ligula mi, non suscipitaccumsan.</p> <span
	...
	<section class="parallax parallax-transparent" data-stellar-background-ratio="0.5">
		<div class="container">
			<div class="row center">
				<div class="col-md-12">
					<i class="fa fa-envelope icon-featured"
						data-appear-animation="bounceIn"></i>
		...
		<div class="row" id="contact">
				...
				<form id="contactForm" action="php/contact-form.php" method="POST">
					<div class="row">
						<div class="form-group">
							...
							<div class="col-md-6">
								<label>Your email address *</label> <input type="email" value=""
			...
			<div class="col-md-6">
				...
				<ul class="list-unstyled">
					...
					<li><i class="fa fa-phone"></i> <strong>Phone:</strong> (123)
						456-7890</li>
