...
<asset:image src="img/slides/slide-bg.jpg" data-bgfit="cover" data-bgposition="left top" data-bgrepeat="no-repeat" alt=""/>		                         <div class="tp-caption top-label lfl stl textFirst"
                                                                                                                                                                        data-x="155"
                                                                                                                                                                        data-y="195"
                                                                                                                                                                        data-speed="300"
                                                                                                                                                                        data-start="500"
