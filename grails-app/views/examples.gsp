		...
		<div class="container">
			...
			<ul class="nav nav-pills sort-source" data-sort-id="portfolio"
				...
				<li data-option-value="*" class="active"><a href="#">Show
						All</a></li>
				<li data-option-value=".websites"><a href="#">Basic Fix</a></li>
				<li data-option-value=".logos"><a href="#">Extensive Editing</a></li>
				<li data-option-value=".brands"><a href="#">Advanced Service</a></li>
			</ul>
			...
			<div class="row">
				...
				<ul class="portfolio-list sort-destination" data-sort-id="portfolio">
					<li class="col-md-3 col-sm-6 col-xs-12 isotope-item websites">
						<div class="portfolio-item img-thumbnail">
							<a href="portfolio-single-project.html" class="thumb-info"> 
								<asset:image src="img/projects/project.jpg" class="img-responsive" />
					...
					<li class="col-md-3 col-sm-6 col-xs-12 isotope-item logos">
						<div class="portfolio-item img-thumbnail">
							<a href="portfolio-single-project.html" class="thumb-info"> <asset:image
								alt="" class="img-responsive" src="img/projects/project-2.jpg" />
								<span class="thumb-info-title"> <span
					...
					<li class="col-md-3 col-sm-6 col-xs-12 isotope-item websites">
						<div class="portfolio-item img-thumbnail">
							<a href="portfolio-single-project.html" class="thumb-info"> <asset:image
								alt="" class="img-responsive" src="img/projects/project-3.jpg" />
								<span class="thumb-info-title"> <span
					...
					<li class="col-md-3 col-sm-6 col-xs-12 isotope-item websites">
						<div class="portfolio-item img-thumbnail">
							<a href="portfolio-single-project.html" class="thumb-info"> <asset:image
								alt="" class="img-responsive" src="img/projects/project.jpg" />
								<span class="thumb-info-title"> <span
									class="thumb-info-inner">SEO</span> <span
									class="thumb-info-type">Website</span>
							</span> <span class="thumb-info-action"> <span title="Universal"
