				...
				<div class="container">
					...
					<nav class="nav-main">
						<ul class="nav nav-pills nav-main" id="mainMenu">
							...
							<li><a data-hash href="#projects">Latest Projects</a></li>
							<li><a data-hash href="#features">Features</a></li>
							<li><a data-hash href="#team">Meet the Team</a></li>
							...
							<sec:ifLoggedIn>
								<li class="dropdown active"><a data-hash
									class="dropdown-toggle" href="#home"> <i class="fa fa-user"></i>
