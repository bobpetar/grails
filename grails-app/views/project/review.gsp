...
<div class="col-md-8">
    ...
    <g:if test="${projectInstance?.task?.finalImage}">
        <div class="isotope-item document col-md-11" style="float:none;">
            ...
            <img class="img-responsive" style="width: 100%;" %{--onError="this.onerror=null;this.src='${createLink(uri: '/')}assets/noimage.png';"--}% src="${grailsApplication.config.retouch.imageServer}${projectInstance?.task?.finalImage?.getWaterMarkedImageName()}"/>
