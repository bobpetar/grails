...
<div role="main" class="main">
    ...
    <div id="edit-coupon" class="content scaffold-edit container" role="main">
        ...
        <div class="panel">
            <g:hasErrors bean="${couponInstance}">
                <ul class="errors" role="alert">
                    <g:eachError bean="${couponInstance}" var="error">
                        <li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
                    </g:eachError>
                </ul>
            </g:hasErrors>
            <g:form url="[resource:couponInstance, action:'update']" method="PUT" >
