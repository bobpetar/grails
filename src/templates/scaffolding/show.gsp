...
<div role="main" class="main">
  ...
  <div id="show-${domainClass.propertyName}" class="content scaffold-show container" role="main">
        ...
        <g:form url="[resource:${propertyName}, action:'delete']" method="DELETE">
            <fieldset class="buttons">
                <g:link class="mb-xs mt-xs mr-xs btn btn-sm btn-default" action="edit" resource="\${${propertyName}}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
